...
## 🏆 Task: CNN for CIFAR-10 Classification

### 🚀 Objective
Train a CNN model to classify images for the CIFAR-10 dataset.

### 📌 Steps:
1. Load the CIFAR-10 dataset using PyTorch.
